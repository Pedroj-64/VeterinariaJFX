...
public class SuperUsuarioViewController {
    ...
    @FXML
    private ComboBox<LocalDate> comboHorario;

    @FXML
    private ComboBox<?> comboMascota;

    @FXML
    private ComboBox<?> comboPropietario;

    @FXML
    private ComboBox<?> comboPropietarioMascota;

    @FXML
    private ComboBox<?> comboVeterinario;
    ...
    @FXML
    private TableColumn<?, ?> tbc_Especialidad;

    @FXML
    private TableColumn<?, ?> tbc_Mascota;

    @FXML
    private TableColumn<?, ?> tbc_cedula;

    @FXML
    private TableColumn<?, ?> tbc_cedulaVeterinario;

    @FXML
    private TableColumn<?, ?> tbc_email;

    @FXML
    private TableColumn<?, ?> tbc_especie;

    @FXML
    private TableColumn<?, ?> tbc_fecha;
